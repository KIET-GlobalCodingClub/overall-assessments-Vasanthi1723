...
SENDER_PASSWORD = "lwrj qnha aezp nrma"   # Gmail App Password, not main password!

# File paths (Windows style fixed ✅)
CERTIFICATE_TEMPLATE_PATH = r"C:/Users/VASANTHI/OneDrive/Desktop/certificate/Gold & Blue Elegant Modern Participation Certificate (1).png"
PARTICIPANTS_FILE_PATH = r"C:/Users/VASANTHI/OneDrive/Desktop/certificate/Book3.csv"
OUTPUT_DIR = r"C:/Users/VASANTHI/OneDrive/Desktop/certificate/generated_certificate"
...
def send_certificate_email(receiver_email, name, certificate_path):
    if not certificate_path:
        print(f"⚠ Cannot send email to {name}, certificate not found.")
        return
    ...
    try:
        ...
        print("❌ Could not connect to Gmail SMTP server. Check internet.")
    except Exception as e:
